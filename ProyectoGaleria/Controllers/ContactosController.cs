...
namespace ProyectoGaleria.Controllers
{
    public class ContactosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Email,Mensaje")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Email,Mensaje")] Contacto contacto)
        {
            if (id != contacto.Id)
            {
                return NotFound();
